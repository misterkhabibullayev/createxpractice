    ...
    const translateLang = {
        en: {
            ...
            blog: {
                ...
                input: "search the blog...",
            },
            ourBlog: {
                ourBlog: "OUR BLOG",
                latestPost: "Latest Post",
                lastTitle: "Do you want more articles, podcasts and videos?",
                lastButton: "Go to blog",
        ...
        uz: {
            ...
            blog: {
                ...
                tags: "Teglar",
                learning: "o'rganish",
                selfDevelopment: "o'zini rivojlantirish",
                coding: "dasturlash",
                marketing: "marketing",
                recruiting: "rekruting",
                input: "blogdan qidirish...",
            },
            ourBlog: {
                ourBlog: "BIZNING BLOG",
                latestPost: "So'nggi post",
                lastTitle:
                    "Yana ko'proq maqolalar, podkastlar va videolarni xohlaysizmi?",
                lastButton: "Blogga o'tish",
        ...
        ru: {
            ...
            blog: {
                ...
                input: "поиск по блогу...",
            },
            ourBlog: {
                ourBlog: "НАШ БЛОГ",
                latestPost: "Последняя публикация",
                lastTitle: "Хотите больше статей, подкастов и видео?",
                lastButton: "Перейти в блог",
                title: "Журнал Createx School",
                allBtn: "Все",
                articlesBtn: "Статьи",
                videosbtn: "Видео",
...
`;
    ...
    function hammaBlog(posts) {
        blogCardlar.innerHTML = posts
            ...
            .map((post) => {
                return `
<div class="my-10 md:my-16 grid grid-cols-3 lg:gap-[45px]">
    ...
    <div class="flex items-center">
        <div class="flex gap-1 items-center">
            ...
            <span class="font-bold text-[14px] text-[#787A80] hover:text-red-500 cursor-pointer">${post[currentLang].type}</span>
        </div>
        <span class="inline-block w-[1px] h-3 bg-[#787A80] rounded-[1px] ml-3"></span>
        <span class="font-bold text-[14px] text-[#787A80] ml-2 hover:text-red-500 cursor-pointer">${post[currentLang].category}</span>
    </div>
    <div>
        <h1 class="font-black text-xl sm:text-3xl md:text-[36px] leading-[130%] text-[#1E212C] max-w-[600px] my-5">${post[currentLang].title}</h1>
        <div class="flex justify-between mb-5">
            <div class="flex items-center gap-4">
                <div class="flex items-center gap-2">
                    <img src="../../../Image/HomePagePhoto/Calendar.svg" />
                    <span class="flex items-center whitespace-nowrap font-bold text-sm text-[#787A80]">${post[currentLang].date}</span>
                </div>
                <div class="flex items-center gap-2 whitespace-nowrap font-bold text-sm text-[#787A80]"><img src="../../../Image/HomePagePhoto/Clock.svg"/>${post[currentLang].duration} 
                </div>
            </div>
            <div class="hidden sm:block">
            <div class="flex items-center gap-2">
                <span class="text-[#787A80]">${translateLang[currentLang].blog.share}:</span>
                <a href="https://www.instagram.com/instagram/" target="_blank"
                        class="${post.author.socialLinks.instagram.hoverColor}">
                               <svg class="cursor-pointer text-[#787A80] hover:text-red-500 transition-colors duration-300"
                    xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 256 256"> <path d="M0 0h256v256H0z" fill="none" />
                ...
                <a href="https://x.com" target="_blank"
                        class="${post.author.socialLinks.twitter.hoverColor}">
                              <svg class="cursor-pointer text-[#787A80] hover:text-red-500 transition-colors duration-300"
	...
	<path fill="currentColor" d="M22.46 6c-.77.35-1.6.58-2.46.69c.88-.53 1.56-1.37 1.88-2.38c-.83.5-1.75.85-2.72 1.05C18.37 4.5 17.26 4 16 4c-2.35 0-4.27 1.92-4.27 4.29c0 .34.04.67.11.98C8.28 9.09 5.11 7.38 3 4.79c-.37.63-.58 1.37-.58 2.15c0 1.49.75 2.81 1.91 3.56c-.71 0-1.37-.2-1.95-.5v.03c0 2.08 1.48 3.82 3.44 4.21a4.2 4.2 0 0 1-1.93.07a4.28 4.28 0 0 0 4 2.98a8.52 8.52 0 0 1-5.33 1.84q-.51 0-1.02-.06C3.44 20.29 5.7 21 8.12 21C16 21 20.33 14.46 20.33 8.79c0-.19 0-.37-.01-.56c.84-.6 1.56-1.36 2.14-2.23" />
                ...
                <a href="https://www.linkedin.com/" target="_blank"
                        class="${post.author.socialLinks.linkedIn.hoverColor}">
                              <svg class="cursor-pointer text-[#787A80] hover:text-red-500 transition-colors duration-300"
                    xmlns="http://www.w3.org/2000/svg" width="22px" height="22px" viewBox="0 0 24 24"> <path d="M0 0h24v24H0z" fill="none" /> <g fill="currentColor">
    ...
    <a href="#" class="inline-block w-full h-auto overflow-hidden rounded mb-4 sm:mb-10">
        <img src="${post.img}" class="w-full h-auto object-cover rounded"/>
    </a>
    <div>
        <h1 class="font-bold text-lg sm:text-[20px] leading-[150%] text-[#1E212C]">${post[currentLang].content.leadTitle}</h1>
        <h3 class="font-normal text-base leading-[160%] text-[#424551] my-3 sm:my-5">${post[currentLang].content.paragraph1}</h3>
        <h3 class="font-normal text-base leading-[160%] text-[#424551] mb-7">${post[currentLang].content.paragraph2}</h3>
        <div class="flex items-start gap-5 mb-7">
            <img src="../../../Image/aboutUs-photo/braces.svg"/>
            <p class="font-semibold text-base sm:text-[20px] sm:font-bold leading-[150%] text-[#1E212C]">${post[currentLang].content.quote}</p>
        </div>
        <h3 class="font-normal text-base leading-[160%] text-[#424551]">${post[currentLang].content.paragraph3}</h3>
        <div class="space-y-3 my-5">
                ${post[currentLang].content.list
                    .map(
                        (item) => `
            <div class="flex items-center gap-2">
                <img src="../../../Image/aboutUs-photo/check.svg"/>
                <p class="font-normal text-base leading-[160%] text-[#424551]">${item}</p>
            </div> `,
                    )
                    .join("")}
        </div>
        <h3  class="font-normal text-base leading-[160%] text-[#424551]">${post[currentLang].content.paragraph4}</h3>
    </div>
    <div class="sm:flex sm:justify-between sm:items-center">
        <div class="flex flex-wrap items-center gap-3 mt-10 mb-4 sm:mb-0">
            <span class="font-bold text-[#787A80]">${translateLang[currentLang].blog.tags}:</span>
              ${tags
                  .slice(3, 6)
                  .map(
                      (item) => `
            <span
                class="border border-[#D7DADD] hover:border-red-500 rounded px-2 py-1 sm:px-4 sm:py-2 text-sm text-[#787A80] hover:text-red-500 transition cursor-pointer">
                ${item[currentLang]}
            </span>`,
                  )
                  .join("")}
...
<div class="hidden lg:block">
    <div class="relative w-full">
        <input type="text" placeholder="${translateLang[currentLang].blog.input}" class="w-full py-2 rounded border border-gray-400 pl-4 pr-14 text-[#424551] placeholder:text-[#9A9CA5] outline-none focus:border-[#FF3F3A] transition"/>
        <button class="absolute right-4 top-1/2 -translate-y-1/2 text-[#424551] hover:text-[#FF3F3A] transition">
            <svg
    ...
    <div class="my-16">
        <h1 class="font-bold text-base leading-[150%] text-[#1E212C] mb-6">${translateLang[currentLang].blog.author}</h1> 
        <div class="flex gap-5">
            <div class="w-auto h-auto max-w-[100px] max-h-[100px]">
                <img src="../../../Image/aboutUs-photo/image.png" class="w-auto h-auto object-cover"/>
            </div>
            <div>
                <h1 class="font-bold text-[20px] leading-[150%] text-[#424551]">${post.author.authorName}</h1>
                <p class="font-normal text-sm text-[#787A80] mb-2">${post.author.authorJob[currentLang]}</p>
                ...
                <a href="https://www.facebook.com/" target="_blank">
                    <svg class="cursor-pointer text-[#787A80] hover:text-red-500 transition-colors duration-300"
                    xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 24 24"> <path d="M0 0h24v24H0z" fill="none" />
                ...
                <a href="https://www.linkedin.com/" target="_blank">
                    <svg class="cursor-pointer text-[#787A80] hover:text-red-500 transition-colors duration-300"
                    xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 24 24"> <path d="M0 0h24v24H0z" fill="none" /> <g fill="currentColor">
		            <path fill-rule="evenodd" d="M12.51 8.796v1.697a3.74 3.74 0 0 1 3.288-1.684c3.455 0 4.202 2.16 4.202 4.97V19.5h-3.2v-5.072c0-1.21-.244-2.766-2.128-2.766c-1.827 0-2.139 1.317-2.139 2.676V19.5h-3.19V8.796h3.168ZM7.2 6.106a1.61 1.61 0 0 1-.988 1.483a1.595 1.595 0 0 1-1.743-.348A1.607 1.607 0 0 1 5.6 4.5a1.6 1.6 0 0 1 1.6 1.606" clip-rule="evenodd" /> <path d="M7.2 8.809H4V19.5h3.2z" /> </g>
                    </svg>
                </a>    
                </div>
        ...
        <div class="my-11">
              <h1 class="font-bold text-base leading-[150%] text-[#1E212C] mb-6">${translateLang[currentLang].blog.recentPosts}</h1>
              <div id="recentPosts"></div>
        </div>

        <div class="mt-10">
            <h1 class="font-bold text-base leading-[150%] text-[#1E212C] mb-6">${translateLang[currentLang].blog.tags.toUpperCase()}</h1>
            <div class="flex flex-wrap items-center gap-2">
              ${tags
                  ...
                  .map(
                      (item) => `
                <span
                    class="border border-[#D7DADD] hover:border-red-500 rounded px-4 py-2 text-sm text-[#787A80] hover:text-red-500 transition cursor-pointer">
                ${item[currentLang]}
                </span>`,
                  )
                  .join("")}
    ...
    <div class="flex gap-5 mb-6">
        ...
        <img src="${post.img}" class="w-auto h-auto object-cover rounded max-w-[100px] max-h-[100px]"/>
        <div>
        <div class="flex items-center gap-2">
                    <img src="../../../Image/HomePagePhoto/Calendar.svg" />
                    <span class="flex items-center whitespace-nowrap font-bold text-sm text-[#787A80]">${post[currentLang].date}</span>
                </div>
            <h1 class="font-bold text-base leading-[160%] text-[#1E212C] hover:text-[#FF3F3A]">${post[currentLang].title}</h1>
        </div>
    </div>
    `;
            })
...
<div class="w-full max-w-[1340px] mx-auto px-5">
    <div class="mx-auto mb-5 md:mb-10">
        <h6 class="text-[#1E212C] font-bold text-base leading-[150%]">
            ${translateLang[currentLang].ourBlog.ourBlog}</h6>
        <div class="flex justify-between items-center">
            <h1 class="text-[#1E212C] font-extrabold text-xl sm:leading-[130%] sm:text-3xl lg:font-black lg:text-4xl">${translateLang[currentLang].ourBlog.latestPost}</h1>
    ...
    <div class="mx-auto lg:flex md:gap-5 items-center text-center justify-center mt-7 sm:mt-16 px-5">
        <h1 class="font-bold text-[20px] sm:text-[28px] leading-[120%] sm:leading-[150%] text-[#1E212C]">${translateLang[currentLang].ourBlog.lastTitle}</h1>
        <a href="../blogs.html">
            <button class="bg-[#F75E05] text-white py-2 w-full sm:w-auto sm:px-7 rounded hover:bg-white hover:text-[#F75E05] hover:border border-[#F75E05] mt-5 lg:mt-0">
            ${translateLang[currentLang].ourBlog.lastButton}</button>
        </a>
    </div>
</div>`;
