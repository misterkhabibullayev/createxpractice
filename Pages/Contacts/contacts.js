const translateData = {
    ...
    ru: {
        ...
        dropUsALine: "Оставьте нам сообщение",
        firstName: "Имя*",
        yourFirstName: "Ваше имя",
        lastName: "Фамилия*",
        yourLastName: "Ваша фамилия",
        email: "Email*",
        yourWorkingEmail: "Ваш рабочий email",
        phone: "Телефон",
    ...
    uz: {
        ...
        dropUsALine: "Bizga xabar qoldiring",
        firstName: "Ism*",
        yourFirstName: "Ismingiz",
        lastName: "Familiya*",
        yourLastName: "Familiyangiz",
        email: "E-pochta*",
        yourWorkingEmail: "Amaldagi e-pochtangiz",
        phone: "Telefon",
        yourPhoneNumber: "Telefon raqamingiz",
        message: "Xabar*",
        yourmessage: "Xabaringiz",
        rozilikEslatmasi: "Createx Online School'dan xabarlar olishga roziman",
    ...
    >
        ...
        <div class="flex items-center gap-3 md:gap-4">
            <div class="flex items-center gap-3 md:gap-4">
                ...
                <a
                    href="/Pages/Login/SignIn/signin.html"
        ...
        <div id="burgerModal" class="absolute top-full left-0 z-10 px-5 w-full flex lg:hidden overflow-hidden transition-all duration-300 origin-top [transform:rotateX(90deg)]">
    ...
    <div class="w-full max-w-[1340px] mx-auto px-5">
        ...
        <div class="md:flex justify-between">
            <div>
                ...
                <div>
                    <div class="flex items-start gap-3">
                        <div>
                            <img src="/Image/HomePagePhoto/Chat1.svg" />
                        </div>
                        <div>
                            <p class="font-[Lato] font-bold text-[14px] leading-[150%] text-[#787A80]">${translateData[currentLang].talkToUs}</p>
                            <a href="mailto:hello@createx.com" class="font-[Lato] font-normal text-[18px] leading-[150%] text-[#1E212C] hover:text-[#FF3F3A] transition-all duration-300">hello@createx.com</a>
                        </div>
                    </div>
                    <div class="flex items-start gap-3 my-6">
                        <div>
                            <img src="/Image/HomePagePhoto/iPhone.svg" />
                        </div>
                        <div>
                            <p class="font-[Lato] font-bold text-[14px] leading-[150%] text-[#787A80]">${translateData[currentLang].callUs}</p>
                            <a href="tel:(405) 555-0128" class="font-[Lato] font-normal text-[18px] leading-[150%] text-[#1E212C] hover:text-[#FF3F3A] transition-all duration-300">(405) 555-0128</a>
                        </div>
                    </div>
                    <div class="flex items-start gap-3">
                        <div>
                            <img src="/Image/HomePagePhoto/address.svg" />
                        </div>
                        <div>
                            <p class="font-[Lato] font-bold text-[14px] leading-[150%] text-[#787A80]">${translateData[currentLang].address}</p>
                            <p class="font-[Lato] font-normal text-[18px] leading-[150%] text-[#1E212C]">2464 Royal Ln. Mesa, New Jersey 45463, USA</p>
                        </div>
                    </div>
                    <div class="mt-[48px]">
            ...
            <div class="w-full md:w-[60%]">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d933.5078660665358!2d60.6226151480396!3d41.557912981258646!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x41dfc9842c81fc9d%3A0x9e434d2b8a616ce9!2sIT%20Park!5e0!3m2!1suz!2s!4v1785501880540!5m2!1suz!2s" class="w-[100%] h-[412px] block border-0" allowfullscreen="" loading="lazy" referrerpolicy="strict-origin-when-cross-origin"></iframe>
            </div>
        </div>
    </div>
`;
